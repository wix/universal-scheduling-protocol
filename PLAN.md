...
| U2 | SHA-pin pages.yml and workflow comments | .github/workflows/pages.yml | grep -E 'uses:.*@v[0-9]' .github/workflows/pages.yml must be empty; each SHA is 40 hex | pending |
| U3 | SHA-pin ci.yml and mirror-to-public.yml | .github/workflows/ci.yml, .github/workflows/mirror-to-public.yml | grep -E 'uses:.*@v[0-9]' .github/workflows/ must be empty (or comments only) | pending |
