...
| U2 | Spec publisher/verifier alignment (§8.2.1, §9.1.4, §10.1.1 + related prose/examples) | specification.md | rg -n 'MUST publish signing material in .keys\|MUST publish signing material in a top-level .keys' specification.md && rg -n 'signing_keys' specification.md \| head -40 | in-progress |
