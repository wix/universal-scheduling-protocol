...
export class USPPlayground {
  ...
  _detectBasePath() {
    // When served by MkDocs, page is at /playground/ and assets are siblings
  ...
  _inlineMockResponse(stepId, scenario) {
    const mocks = {
      ...
      availability: {
        ...
        'range-too-wide': {
          _status: 422,
          type: 'https://usp.dev/errors/range-too-wide',
      ...
      hold: {
        ...
        unavailable: {
          _status: 409,
          type: 'https://usp.dev/errors/slot-unavailable',
        ...
        'limit-exceeded': {
          _status: 409,
          type: 'https://usp.dev/errors/hold-limit-exceeded',
      ...
      book: {
        ...
        'validation-error': {
          _status: 422,
          type: 'https://usp.dev/errors/validation',
      ...
      payment: {
        ...
        failed: {
          _status: 422,
          type: 'https://usp.dev/errors/payment-failed',
        ...
        'actions-pending': {
          _status: 422,
          type: 'https://usp.dev/errors/actions-pending',
